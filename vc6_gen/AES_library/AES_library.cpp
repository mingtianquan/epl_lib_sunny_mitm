...
#include "3rdparty/AES_library/x86/AES_library.h"
...
EXTERN_C INT WINAPI AES_library_ProcessNotifyLib (INT nMsg, DWORD dwParam1, DWORD dwParam2)
{
#ifndef __E_STATIC_LIB
    if(nMsg == NL_GET_CMD_FUNC_NAMES)
        return (INT) g_CmdNames;
    else if(nMsg == NL_GET_NOTIFY_LIB_FUNC_NAME)
        return (INT) "AES_library_ProcessNotifyLib";
...
#define		LI_LIB_GUID_STR	"A29036836C8246ab8026915351CFCF0D"
...
/*pfnNotify*/				AES_library_ProcessNotifyLib,
